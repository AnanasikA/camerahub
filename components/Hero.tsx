...
export default function Hero() {
  return (
    <section className="relative flex min-h-[92vh] items-center overflow-hidden">
      ...
      <div className="relative max-w-wrap mx-auto w-full px-6 py-32 md:px-10 md:py-48">
        <motion.h1
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
          className="font-display max-w-[18ch] text-[clamp(3rem,7vw,6.5rem)] font-medium leading-[0.96] tracking-tightest text-bg"
        >
          Uchwyć każdą chwilę.
        </motion.h1>
        <motion.p
          ...
          className="mt-7 max-w-[50ch] text-lg leading-relaxed text-bg/85 md:text-xl"
        >
